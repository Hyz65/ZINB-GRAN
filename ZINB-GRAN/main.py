...
FLAGS = flags.FLAGS
flags.DEFINE_string('model', 'ZINB_GRAN', 'Model string.')  # 'gcn', 'gcn_cheby', 'dense'
...
input_path ="C:/Users/Administrator/Desktop/单细胞2/DeepRIG-main/Datasets/500_ChIP-seq_hESC/"
#input_path ="C:/Users/Administrator/Desktop/单细胞2/ZINB_GRAN-main/Datasets/CD14/"
output_path = "C:/Users/Administrator/Desktop/单细胞2/DeepRIG-main原 - 副本/output/"
...
#label_file = input_path + 'network.csv'


reverse_flags = 0   ###whether label file exists reverse regulations, 0 for DeepSem data, 1 for CNNC data
#原labels, adj, AM, gene_names, TF= prepareData(FLAGS, data_file, label_file, reverse_flags)
#改
