...
if __name__ == '__main__':
	parser = argparse.ArgumentParser(description = 'Evaluate for the inferred results of ZINB_GRAN from scRNA-seq data.')
	parser.add_argument('-p','--pred_file', type = str,
						default="C:/Users/Administrator/Desktop/单细胞2/scGREAT-main/scGREAT-main/output/mESC_epoch10 - 副本.csv",
                        help='Path to inferred results file. Required. \n')
	parser.add_argument('-n','--network', type = str,
						default="C:/Users/Administrator/Desktop/单细胞2/ZINB_GRAN-main/Datasets/500_ChIP-seq_mESC/500_ChIP-seq_mESC-network.csv",
